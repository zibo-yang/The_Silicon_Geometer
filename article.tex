...
\begin{proposition}
	Prove $(\text{Spec}\,R, \mathscr{O}_{\spec})$ is a locally ringed space.
\end{proposition}
...
% snippet of code to be included here for `locale topological_space`
...
% snippets of code to be included here for `inductive generated_topology` and the `lemma generated_topology_is_topology` 
\\
