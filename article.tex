...
In Church's original conception, the sole purpose to types is to prevent inconsistency. People today, influenced by programming languages, prefer to give types a more dominant role.
...
\begin{thebibliography}{}
	...
	\bibitem{typestosets}
	Kunčar, O., Popescu, A.:
	\newblock \textit{From Types to Sets by Local Type Definition in Higher-Order Logic}. 
	\newblock J. Autom. Reason. 62, 237–260 (2019)
	
	\bibitem{PaulsonLamport}
