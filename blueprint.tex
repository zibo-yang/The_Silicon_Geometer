...
\begin{ex}
	Let $\lbrace \mathfrak{a}_i \rbrace$ be a family of ideals of $R$ indexed by a set $I$. One defines the set $\sum \mathfrak{a}_i$ to be the set 
	\[
	\lbrace \sum_{i \in I} a_i \mid a_i \in \mathfrak{a}_i \rbrace .
	\]
	Check that $\sum \mathfrak{a}_i$ is an ideal of $R$.  
\end{ex}
